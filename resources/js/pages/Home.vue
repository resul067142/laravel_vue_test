                ...
                <div class="card-body">
                    ...
                    <div v-if="yarismaBasladi && sorular && sorular.length && secilenSoru" class="row">
                        <div class="col-12 m-2">
                            ...
                            <div style="background-color: darkcyan; color: white; min-height: 50px;">
                                {{secilenSoru.soru}}
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-2 text-center">
                            <button class="btn btn-success" style="width: 250px" @click="bitir" :disabled="bittiMi" v-if="yarismaBasladi">Bitir</button>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="score in scores">
                                <td><img class="rounded-circle" :src="'uploads/' + score.img_url" style="height: 80px; width: 80px" alt=""/></td>
                                <td>{{ score.name }}</td>
                                <td>{{ score.score }}</td>
                            </tr>
                        </tbody>
...
export default {
    ...
    methods: {
        ...
        bitir() {
            ...
            axios.post('/api/scores', formData).then(res => {
